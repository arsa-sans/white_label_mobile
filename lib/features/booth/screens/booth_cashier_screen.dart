...
class BoothCashierScreen extends StatefulWidget {
  const BoothCashierScreen({super.key});

  @override
  State<BoothCashierScreen> createState() => _BoothCashierScreenState();
}

class _BoothCashierScreenState extends State<BoothCashierScreen> {
  ...
  List<Map<String, dynamic>> _sessionTx = [];
